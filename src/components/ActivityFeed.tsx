                      ...
                      return (
                        <div className="flex items-center justify-start gap-2 mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800">
                          ...
                          <div className="flex flex-wrap items-center gap-1 min-w-0">
                            {/* Preset Buttons - hidden until at least one person has used them.
                                FOMO Alert and Imposter no longer get a permanent icon-only slot
                                to be "discovered" from - the react button's quick popup already
                                surfaces all 5 presets directly, so there's no need to reserve
                                space for ones nobody's used yet. */}
                              ...
                              return (
                                <div key={react.key} className="relative group shrink-0">
                                  <button
                                    ...
                                    className={`flex items-center gap-1 rounded-full text-[9px] font-extrabold border transition-all duration-150 active:scale-95 hover:scale-105 cursor-pointer select-none py-0.5 px-2 ${
                                      hasReacted
                            ...
                            <div className="relative shrink-0">
                              <button
                                ...
                                className={`flex items-center justify-center w-7 h-7 rounded-full border-2 transition-all active:scale-90 hover:scale-105 cursor-pointer ${
                                  activeReactionPicker?.logId === log.id
                                    ? "bg-amber-500 border-amber-500 text-white shadow-xs"
                                    : "bg-amber-50 dark:bg-amber-500/10 border-amber-300 dark:border-amber-500/40 text-amber-600 dark:text-amber-400 hover:bg-amber-100 dark:hover:bg-amber-500/20 hover:border-amber-400"
                                }`}
                                title="React"
                              >
